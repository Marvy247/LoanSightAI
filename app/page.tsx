          ...
          >
            <Link href="/dashboard">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Button size="lg" className="bg-gradient-to-r from-zinc-900 to-zinc-700 hover:from-blue-800 hover:to-purple-900 text-white text-lg px-10 py-6 shadow-xl shadow-blue-500/20">
